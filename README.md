...
| **Crop classification and yields** | Dual-pol or quad-pol backscatter + coherence. Time series/change detection. C-band | Could enhance DEA land-cover agriculture information. | Experimental. Successful in Wales (Sentinel-1) but coverage higher than Australia’s. <br>[Living Wales approach](https://doi.org/10.3390/rs13050846) | [Assign yourself](https://github.com/YOUR-ORG/YOUR-REPO/projects/PROJECT-ID) |
| **Soil Moisture** | Backscatter and emissivity | No known DEA value add. | Operational product exists — ESA CCI daily active+passive SAR soil moisture product. <br>[ESA CCI Soil Moisture](https://climate.esa.int/en/projects/soil-moisture/) | [Assign yourself](https://github.com/YOUR-ORG/YOUR-REPO/projects/PROJECT-ID) |
